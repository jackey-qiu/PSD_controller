...
class syringe_widget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        rects_resevoir = self.draw_bottle(qp, fill_height = self.resevoir_volumn/250*200, offset = [1*0+ left_bound_resevoir,8+2],volume=self.resevoir_volumn_total,label = 'Resevoir')
    ...
    def draw_mvp_valve(self,qp, dim, connected_channel = 3):
        ...
        qp.setPen(QPen(Qt.red,  4, Qt.SolidLine))
        qp.drawText(dim[0]-50,dim[1]+80,"{}-->MVP".format(self.mvp_connected_valve))
